...
with tab_overview:
    ...
    # Ensure numeric
    df_unique['Sell Price'] = pd.to_numeric(df_unique['Sell Price'], errors='coerce').fillna(0)

    if 'Buying Price' in df_unique.columns:
        df_unique['Buying Price'] = pd.to_numeric(df_unique['Buying Price'], errors='coerce')
        df_unique['Buying Price'] = df_unique['Cost'].fillna(0)  # missing Cost treated as 0
    else:
        df_unique['Buying Price'] = 0
